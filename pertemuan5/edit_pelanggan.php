  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="kode" name="kode" type="text" class="form-control" value="<?php if (isset($_GET["idedit"])) {echo $row ["nama"];} ?>">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="jk" name="jk" 
        value="P" type="radio" class="form-control" <?php if(isset($_GET["idedit"])) {if($row["jk"] == "L"){echo "checked";}} ?>> <label for="Perempuan" class="mt-2">Perempuan</label>
      </div>
    </div>
  </div>
  <div class="form-group row">
